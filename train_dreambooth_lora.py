...
def main(args):
    # Move all heavy imports inside main to avoid issues with accelerate
    import copy
    import gc
    import logging
    import math
    ...
    # Define helper functions inside main
    def log_validation(
        pipeline,
        args,
        accelerator,
...
"""
    ...
    # Define the DreamBoothDataset class inside main
